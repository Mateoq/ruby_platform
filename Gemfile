...
# ASSETS
	...
	gem 'rails-assets-angular-sanitize', '~> 1.4.1'
	gem 'rails-assets-videojs', '~> 4.12.5'
	gem 'rails-assets-dropzone'
	gem 'rails-assets-waves'
	# gem 'rails-assets-videogular', '~> 1.2.3'
	# gem 'rails-assets-videogular-core', '~> 1.2.3'
	# gem 'rails-assets-videogular-poster', '~> 1.2.3'
	# gem 'rails-assets-videogular-controls', '~> 1.2.3'
	# gem 'rails-assets-videogular-buffering', '~> 1.2.3'
