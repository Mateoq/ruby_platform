prTemplates.directive('pairLines', ['$window', '$timeout', 'pairsActivityService', 'updateProgressService', function ($window, $timeout, pairsActivityService, updateProgressService) {
	return {
   ...
   //          }
			...
			pairsActivityService(scope.options.activity, scope.$root.game, scope.options.done, function (numItems, rightAnswers) {
				var data = {
					num_items: numItems,
