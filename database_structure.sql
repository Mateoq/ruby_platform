...
INSERT INTO course_data VALUES (6, 'Tema 2-3', 7, '{"lessonTitle":"Gráfica de barras","footerBackground":"#4D869F","footerHeight":"213px","images":[{"src":"daniel_frente.png","styles":"bottom: 80px; left: 30px;"},{"src":"elemen_deporte.png","styles":"bottom: 80px; left: 204px;"}],"stylesInstructionCol":"float: none; position: relative; left: 20px; margin: auto","instruction":{"hasContent":true,"hasInstruction":true,"instructionBg":"yellow-background","styles":"width: 100%;","contentStyles":"width: 50%;","contentHeaderStyles":"width:100%;","contentTitleStyles":"font-size: 21px;","instructionStyles":"width: 50%; height: 118px;","contentMainStyles":"height: 62px; font-size:12px;","title":"Gráfica de barras","text":"Daniel preguntó a sus amigos cuál es su deporte favorito y organizó la información en una gráfica.","instruction":"Haz clic sobre cada deporte para visualizar su gráfica.","contentIcon":"pr-icon-notebook"}}', 1, 5, true, '2014-11-19 09:40:29.86523', '2014-11-19 11:15:33.593662', 'theme-2-3');
...
SELECT pg_catalog.setval('course_data_id_seq', 6, true);
...
INSERT INTO user_progresses VALUES (119, 'mat_04_03_02', NULL, 'mjquintero@ucn.edu.co', 4, NULL, 2, 118, true, true, '2014-11-10 17:53:35.242747', '2014-11-19 18:10:47.451296');
...
SELECT pg_catalog.setval('user_progresses_id_seq', 125, true);
